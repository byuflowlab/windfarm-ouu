...
if __name__ == "__main__":
    ...
    n = 40  # number of points, i.e., number of winddirections and windspeeds pairs
    ...
    prob.driver.opt_settings['Print file'] = 'SNOPT_print_layout1_40_dakota.out'
    prob.driver.opt_settings['Summary file'] = 'SNOPT_summary_layout1_40_dakota.out'
    ...
    np.savetxt('layout_1_40_XY_dakota.txt', np.c_[prob['turbineX'], prob['turbineY']], header="turbineX, turbineY")
    ...
    jsonfile = open('layout_1_40_dakota.json','w')
