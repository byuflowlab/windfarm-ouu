...
if __name__ == "__main__":
    ...
    prob.driver.opt_settings['Print file'] = 'SNOPT_print_layout2_20_dakota.out'
    prob.driver.opt_settings['Summary file'] = 'SNOPT_summary_layout2_20_dakota.out'
    ...
    np.savetxt('layout_2_20_XY_dakota.txt', np.c_[prob['turbineX'], prob['turbineY']], header="turbineX, turbineY")
    ...
    jsonfile = open('layout_2_20_dakota.json','w')
