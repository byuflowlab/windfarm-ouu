...
# Figure 1 - Direction all 5 simulations
# Different methods
method = ['dir_rect.json', 'dir_dakota.json']
# Different layouts
layout = ['grid', 'amalia', 'optimized', 'lhs']
# layout = ['grid', 'amalia', 'optimized', 'random']

# Different simulations
simulations = ['m2', 'm1', '0', '1', '2']
...
# Figure 2 - Speed all 5 simulations for rect and 1 simulation for Dakota
# Different methods
...
# Figure 3 - Direction Mean, min, max
...
ax[3][1].set_xlabel('# speeds')
ax[3][2].set_xlabel('# speeds')
# plt.savefig('Statistics_convergence.pdf', transparent=True)


# Figure 4b - Speed Mean convergence, doesn't average over starting points
...
#plt.savefig('Error_statistics_convergence.pdf')
plt.savefig('MeanError_statistics_convergence_direction.pdf', transparent=True)


# Figure 6 - Speed Error, doesn't average over starting points

# Different layouts

method = ['speed_rect.json', 'speed_dakota.json']
# method = ['dakota_speed.json']
layout = ['grid', 'amalia', 'optimized', 'lhs']
# layout = ['grid', 'amalia', 'optimized', 'random']
