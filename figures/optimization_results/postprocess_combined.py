...
ax[0][0].text(3200, 5000, '695', fontsize=14)
ax[0][0].text(0, -700, 'Princess Amalia')
ax[1][0].scatter(tXama, tYama)
ax[1][0].set_axis_off()
ax[1][0].set_xlim([-190, 3990])
ax[1][0].set_ylim([-245, 5145])
ax[1][0].set_aspect('equal')
ax[1][0].text(3200, 5000, '695', fontsize=14)
ax[1][0].text(0, -700, 'Princess Amalia')
...
ax[0][6].text(4600, 4200, 'GWh - AEP of the layout as measured \nby using rectangular integration with \nn=100 directions')
ax[0][6].text(2600, -700, 'Number of wind directions used to calculate AEP')
ax[0][0].text(0, 5800, 'Polynomial chaos', fontsize=16)
ax[1][0].text(0, 5800, 'Rectangle rule', fontsize=16)
fig.tight_layout()
...
ax.plot(samples_rect, rect_mu, label='rectangle rule', linewidth=2) #, c='c')
ax.plot(samples_dakota, dakota_mu, label='polynomial chaos', linewidth=2) #, c='orange')
ax.set_xlim(-2,102)
ax.set_ylim(689,731)
ax.legend(loc=2, frameon=False)
ax.set_xlabel('Number of wind directions')
ax.set_ylabel('Optimized AEP (GWh)')
fig.tight_layout()
